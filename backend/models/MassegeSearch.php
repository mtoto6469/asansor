...
/**
 * MassegeSearch represents the model behind the search form of `backend\models\Massege`.
 */
class MassegeSearch extends Massege
{
    ...
    {
        return [
            [['id', 'id_user', 'id_pro', 'displacementheight', 'enable_view','confirm'], 'integer'],
    ...
    {
        $query = Massege::find()->where(['enable_view'=>1])->andWhere(['confirm'=>0]);
